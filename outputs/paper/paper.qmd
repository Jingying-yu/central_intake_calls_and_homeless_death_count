---
title: "Some Correlations were Found between the efforts made by the Staff of Toronto's Central Intake Line and Toronto's Homeless Death Counts"
author: 
  - Sandy Yu
...
combined_data|> ggplot(mapping = aes(x = Month, y = Death_Count)) + 
  ...
  labs(
    title = "Correlation between number of Calls Coded and Homeless Death Count",
    x = "Time (in Month)",
    y = "Count"
  )
...
combined_data|> ggplot(mapping = aes(x = Month, y = Death_Count)) + 
  ...
  labs(
    title = "Correlation between of Callers Referred to Shelter & Homeless Death",
    x = "Time (in Month)",
    y = "Count"
  )
#still need to add a legend or label, but I haven't yep figured out how
...
combined_data|> ggplot(mapping = aes(x = Month, y = Death_Count)) + 
  ...
  labs(
    title = "Correlation between Callers given Info on Homelessness Prevention and Homeless Death",
    x = "Time (in Month)",
    y = "Count"
  )
#still need to add a legend or label, but I haven't yep figured out how
